...
const DashboardHome = () => {
  return (
    <main className="flex-1 p-3 sm:!p-6 space-y-12">
      ...
      <section>
        <div className="mb-6">
          <div className="border-2 border-gray-700 border-dashed p-10 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-purple-400 w-fit">
