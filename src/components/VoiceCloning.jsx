...
const VoiceCloning = () => {
  ...
  return (
    <section className="flex flex-col items-start  min-h-screen p-4">
      {/* Title */}
      <h2 className="text-xl sm:text-2xl font-inter font-semibold text-white text-center mb-24">
        Clone Your Voice
      </h2>
      <div className="w-full max-w-[633px] mx-auto space-y-10">
        {/* Upload Section */}
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-white font-inter text-2xl font-light mb-6">
            Clone a Voice
          </h2>
          <div className="bg-[#43434333] rounded-xl border border-[#2A2A2A] p-6 text-center cursor-pointer hover:border-[#8267EC] transition max-w-[320px] w-full">
            <div className="bg-[#101010] px-4 py-3 w-fit h-fit rounded-md mb-5 mx-auto">
              <img src="/upload.svg" alt="upload" className="h-8 w-8  mx-auto" />
            </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {voices.map((voice, index) => (
              <div
                key={index}
                className="flex items-center justify-between bg-transparent rounded-lg"
              >
                {/* Left: Avatar + Info */}
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-2 items-center">
                    <p className="text-white font-inter font-medium text-sm sm:text-base">
                      {voice.name}
                    </p>
