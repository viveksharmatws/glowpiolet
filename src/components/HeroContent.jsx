  ...
  return (
    <>
      <div className="flex justify-center">
        ...
        tracking-[-0.0375em]   /* -1.5px letter-spacing */
        ...
        "
          ...
          <div className="flex flex-col items-center">
            <div
              ...
              className="p-4 font-semibold font-inter rounded-full mx-auto py-4 px-9 mt-5 cursor-pointer 
